...
object TableViewPage {
    ...
    showcasePage(i18n"TableView", i18n"Large data sets that breathe and flow.") {
      vbox {
        ...
        sectionIntro(
          ...
          i18n"This page now keeps exactly one large table example so the relationship between the fixed column header and the scrolling content header stays obvious."
        )
        ...
        componentShowcase(
          i18n"Scrolling header with large table",
          i18n"A single remote example shows sortable columns, many rows, and the new body header that scrolls with the data."
        ) {
          tableView[ShowcaseBook] {
            ...
            titleColumn.$prefWidthProperty.set(320.0)
            ...
            authorColumn.$prefWidthProperty.set(280.0)
            ...
            yearColumn.$prefWidthProperty.set(120.0)
            ...
            header {
              div {
                ...
                div {
                  ...
                  text = DemoI18n.resolveNow(i18n"1,000 remote books with a scrolling table header")
                }
                div {
                  style { color = "var(--aj-ink-muted)" }
                  text = DemoI18n.resolveNow(i18n"Sort by title, author, or year and keep the extra header attached to the scrolled rows.")
                }
              }
            }
        ...
        insightGrid(
          ...
          (i18n"Header", i18n"Column header and body header differ", i18n"The built-in column header stays fixed while the custom body header scrolls with the rows."),
  ...
  header {
    div {
      text = "Scrolling table body header"
    }
  }
