...
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-viewport" % "2.2.9"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-i18n" % "2.2.9"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-json" % "2.2.9"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-controls" % "2.2.9"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-forms" % "2.2.9"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-editor" % "2.2.9" // optional, includes Lexical
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-webauthn" % "2.2.9" // optional, browser-side passkeys
```
