...
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-router" % "2.3.0"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-viewport" % "2.3.0"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-i18n" % "2.3.0"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-json" % "2.3.0"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-controls" % "2.3.0"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-forms" % "2.3.0"
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-editor" % "2.3.0" // optional, includes Lexical
libraryDependencies += "com.anjunar" %%% "scalajs-jfx2-webauthn" % "2.3.0" // optional, browser-side passkeys
```
